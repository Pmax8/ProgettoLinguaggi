            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <?php
			    ...
			    if(!isset($_SESSION['name'])){
			      	echo "<li class='account'><a  href='User/SignUp/index.php'> Sign Up </a></li>
				      	<li class='account'><a  href='User/Login/index.php'> Log In </a></li>";
		    	}
		    	else {
			      	echo "<li><a id='giudizio' href='Local/Feedback/index.php'>Give your feedback!</a></li>";
				      echo "<li class='account'><a  href='User/Logout/index.php'>Log out</a></li>";
			    }
			    ?>
          </li>
		        </ul>
